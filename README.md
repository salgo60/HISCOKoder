...
Tanken
* starta dela planer --> [diskussion](https://github.com/salgo60/HISCOKoder/discussions) eller [issues](https://github.com/salgo60/HISCOKoder/issues) fungera som en start eller varför inte [Clubhouse](https://www.clubhouse.com/)
